...
TEST CLASS: LivroRepositoryTest
...
1. findByTitulo(String titulo) -> List<Livro>
2. findByAno(int ano) -> List<Livro>
3. findByAutor(Autor autor) -> List<Livro>
4. findById(Long id) -> Optional<Livro>
5. findByAnoMaiorQue(int ano) -> List<Livro>

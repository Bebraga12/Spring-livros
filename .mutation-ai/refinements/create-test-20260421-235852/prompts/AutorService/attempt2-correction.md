...
public class AutorServiceTest {
    ...
    @Test
    public void testFindByIdAutor_WhenAutorExists() {
        Long id = 1L;
    ...
    @Test
    public void testFindByIdAutor_WhenAutorDoesNotExist() {
        Long id = 1L;
    ...
    @Test
    public void testUpdateAutor_WhenAutorExists() {
        Long id = 1L;
    ...
    @Test
    public void testUpdateAutor_WhenAutorDoesNotExist() {
        Long id = 1L;
        Autor autorToUpdate = new Autor();
        when(autorRepository.findById(id)).thenReturn(Optional.empty());
